    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                ...
                @endif
                <div class="container">
                    <form method="POST" action="{{route('donvi.store')}}" class="needs-validation" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="uname">Cấp:</label>
                            <input type="longtext" class="form-control" value="" placeholder="Tiêu đề" name="cap"required>
                            <!-- <div class="invalid-feedback">Vui lòng nhập tên bài viết.</div> -->
                        </div>
