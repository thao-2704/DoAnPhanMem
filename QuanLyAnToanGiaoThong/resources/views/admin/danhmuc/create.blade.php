    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                ...
                @endif
                <div class="container">
                    <form method="POST" action="{{route('danhmuc.store')}}" class="needs-validation" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="" placeholder="Tiêu đề" name="noidung"required>
                            <!-- <div class="invalid-feedback">Vui lòng nhập tên bài viết.</div> -->
                        </div>
