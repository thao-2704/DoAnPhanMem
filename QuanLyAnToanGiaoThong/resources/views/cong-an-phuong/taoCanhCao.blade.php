...
<section class="main-content">
    ...
    <div class="content">
       ...
       <form action="#">
            ...
            <div class="infomation" >
                <div class="inf" >
                     ...
                     <input type="text" name="thietBi" placeholder="Phương tiện, thiết bị">
                </div>
                <div class="inf" style="margin: auto;">
            ...
            <div class="infomation" >
                <div class="inf" >
                     ...
                     <input type="text" name="phuongTien" placeholder="Phương tiện">
                </div>
                <div class="inf" style="margin: auto;">
       ...
       <label>có mặt tại trụ sở Công an quận Thanh Khê để giải quyết vụ việc vi phạm theo quy định của pháp luật.</label>
    </div>
